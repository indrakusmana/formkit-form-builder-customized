...
const classes: Record<string, Record<string, boolean>> = {
  ...
  color__inner: {
    ...
    "dark:group-data-[prefix-icon]:border-zinc-800": true,
    "dark:group-data-[suffix-icon]:border-zinc-800": true,
  },
  color__input: {
    "appearance-none": true,
    "[color-scheme:light]": true,
  ...
  range__input: {
    ...
    "dark:[&::-webkit-slider-runnable-track]:bg-zinc-600/50": true,
    ...
    "dark:[&::-webkit-slider-thumb]:group-data-[disabled]:!ring-zinc-700":
      true,
    ...
    "dark:[&::-moz-range-track]:bg-zinc-600/50": true,
  ...
  autocomplete__selectionWrapper: {
    ...
    "dark:group-data-[multiple]:border-zinc-700": true,
  ...
  slider__minValue: {
    ...
    "dark:[&>div>div::after]:bg-zinc-800": true,
  },
  slider__maxValue: {
    grow: true,
    "!max-w-[45%]": true,
  ...
  "multi-step__tabs": {
    ...
    "dark:group-data-[tab-style=tab]/wrapper:border-zinc-800": true,
  ...
  "multi-step__tab": {
    ...
    "dark:group-data-[tab-style=progress]/wrapper:before:border-zinc-800":
      true,
    ...
    "dark:group-data-[tab-style=progress]/wrapper:after:bg-zinc-800": true,
