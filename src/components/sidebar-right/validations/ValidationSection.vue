...
const showForFieldType = (validationType: string, fieldType: string | null) => {
  const validationMap: Record<string, string[]> = {
    ...
    date_after: ['date', 'datetime-local', 'naiveDatetimeLocal', 'date-time', 'naiveDateTime'],
    date_before: ['date', 'datetime-local', 'naiveDatetimeLocal', 'date-time', 'naiveDateTime'],
    date_between: ['date', 'datetime-local', 'naiveDatetimeLocal', 'date-time', 'naiveDateTime'],
